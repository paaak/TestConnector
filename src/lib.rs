// src/lib.rs
/*
 * Core library for TestConnector
 */
...
#[derive(Debug)]
pub struct TestConnectorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TestConnectorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TestConnector processing");
    
    let mut processor = TestConnectorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TestConnectorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TestConnectorProcessor::new(false);
